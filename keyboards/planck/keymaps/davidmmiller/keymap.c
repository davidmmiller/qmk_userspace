...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_ESC,                 MT(MOD_LALT,KC_A), MT(MOD_LCTL,KC_S), MT(MOD_LGUI,KC_D), MT(MOD_LSFT,KC_F), LT(_MOVEMENT,KC_G), KC_H, MT(MOD_RSFT,KC_J), MT(MOD_RGUI,KC_K), MT(MOD_RCTL,KC_L), MT(MOD_RALT,KC_SCLN), KC_QUOT,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_DEL,  _______, _______, _______, _______, _______, KC_BSLS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______, _______, _______, _______, _______, _______, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_RALT, KC_VOLU, KC_MPLY
),
...
[_MOVEMENT] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, LALT(KC_LEFT), _______, _______, LALT(KC_RGHT), _______, _______, _______, _______
),
