...
/* I use homerow mods ACGS 
 *           Alt Ctrl GUI Shift
 * I added a arrows/movement layer under 'g' as activation key
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   [_QWERTY] = LAYOUT(
    ...
    KC_ESC,   MT(MOD_LALT, KC_A), MT(MOD_LCTL, KC_S), MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), LT(_ARROWS, KC_G),                     KC_H,    MT(MOD_RSFT, KC_J), MT(MOD_RGUI, KC_K), MT(MOD_RCTL, KC_L), MT(MOD_LALT, KC_SCLN), KC_QUOT,
...
/* I removed the unused _ADJUST layer, so don't need tri_layer function */
